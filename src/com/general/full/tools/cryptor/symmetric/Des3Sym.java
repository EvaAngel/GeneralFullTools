package com.general.full.tools.cryptor.symmetric;
...
import static com.general.full.tools.cryptor.symmetric.AesSym.parseByte2HexStr;
import static com.general.full.tools.cryptor.symmetric.AesSym.parseHexStr2Byte;

/**
 * 该类为DES的衍生算法，密钥为24个字节，iv 8个字节
 *
 * **/
public class Des3Sym {
    static String key="aaabbbcccdddeeefffggghhh";
    ...
    public String encrypt(String mingwen,String codekey,String key,String codeiv,String iv,String work,String full,String code)
    {
        ...
        Key keySpec= new SecretKeySpec(a,"DESede");
        IvParameterSpec ivSpec = new IvParameterSpec(b);
        Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
        try {
            cipher = Cipher.getInstance("DESede/"+work+"/"+full);
            if (work.equals("ECB")) {
                //初始化实例
    ...
    {
        String miwen=new Des3Sym().encrypt("fuxin","String",key,"String",iv,"CBC","PKCS5Padding","Base64");
        System.out.println(miwen);
        String mingwen=new Des3Sym().decrypt(miwen,"String",key,"String",iv,"CBC","PKCS5Padding","Base64");
